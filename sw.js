...
const SYNNICAL_PROXY_PREFIX = new URL("./~/sj/", self.location.href).pathname
importScripts(new URL(`./controller/controller.sw.js?synnical-runtime=${SYNNICAL_PROXY_RUNTIME}`, self.location.href).href)
